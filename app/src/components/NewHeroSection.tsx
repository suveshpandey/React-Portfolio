...
export default function HeroWithStats() {
    return (
        <section className="w-full min-h-screen h-auto flex flex-col md:flex-row items-center justify-between overflow-hidden pt-30 sm:pt-0">
                ...
                <div className="w-full flex flex-col gap-y-6">
                    <div className="w-full flex flex-col sm:flex-row gap-x-10 gap-y-4 items-center sm:justify-start justify-center">
                        <img
                            src={profilePic}
                            alt="profile"
                            className="w-30 h-30 sm:w-32 sm:h-32 rounded-full ring-2 ring-neutral-800 object-cover shadow-lg"
                        />
                        <div className="flex flex-col gap-y-2 justify-center sm:items-start items-center">
                            <motion.h1
                                ...
                                initial="hidden"
                                animate="visible"
                                className="w-full text-4xl sm:text-5xl font-medium tracking-tight text-slate-300"
                                >
                                    Suvesh Pandey
                            </motion.h1>
                            ...
                            <motion.h1 
                                ...
                                initial="hidden"
                                animate="visible"
                                className="text-xl sm:text-2xl bg-gradient-to-r from-pink-300 via-slate-500 to-purple-500 bg-clip-text tracking-tight text-transparent">
                    ...
                    <div className="w-full flex flex-col gap-4 items-center sm:items-start">
                        ...
                        initial="hidden"
                        animate="visible"
                        className="mt-3 text-gray-400 text-center sm:text-left"
                        >
                        ...
                        <div className="w-full mt-6 flex items-center justify-center">
                            <motion.button
                                ...
                                className="inline-flex items-center gap-3 px-5 py-3 rounded-2xl font-medium shadow-lg transition-transform transform hover:scale-105 ease-linear cursor-pointer duration-200"
                                style={{
